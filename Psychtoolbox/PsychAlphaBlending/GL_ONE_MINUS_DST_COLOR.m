function constantString=GL_ONE_MINUS_DST_COLOR

% constantString=GL_ONE_MINUS_DST_COLOR
%
% Return the string 'GL_ONE_MINUS_DST_COLOR', which specifies an alpha blending
...
%
% GL_ONE_MINUS_DST_COLOR may only be used as a source factor, not a
% destination factor.
% 
%

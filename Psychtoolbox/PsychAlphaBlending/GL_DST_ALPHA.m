function constantString=GL_DST_ALPHA

% constantString=GL_DST_ALPHA
%
% Return the string 'GL_DST_ALPHA', which specifies an alpha blending
...
%
% GL_DST_ALPHA may be used as either a source or a destination factor.
% 
%

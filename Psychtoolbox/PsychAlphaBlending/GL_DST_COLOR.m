function constantString=GL_DST_COLOR

% constantString=GL_DST_COLOR
%
% Return the string 'GL_DST_COLOR', which specifies an alpha blending
...
%
% GL_DST_COLOR may only be used as a source factor, not a
% destination factor.
% 
%

% FitGammaDemo.
%
% Shows how function FitGamma may be used
% to fit various functions through measured gamma data.
% We typically call FitGamma in scripts that perform
% calibrations to generate a full gamma table.
%
...
plot(typicalGammaInput,typicalGammaData,'+');
for i = 1:7
    theFit(:,i) = FitGamma(typicalGammaInput,typicalGammaData,output,i);
end
...
% Execute these to copy either data or extended fit to clipboard.

...
try
    ...
    while (abortit<2)
        ...
        % Asynchronously load the next movie file while current one is
        % playing. Get moviename of next file:
        ...
        % Ok, now our newmovie becomes movie:
        movie = newmovie;

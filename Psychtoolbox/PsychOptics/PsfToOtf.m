...
%    the same number of evenly spaced samples.  The number of samples
%    should be even. Position (0,0) should be at location n/2+1 in each
%    dimension.
%
...
sfCyclesDeg = 60*(-n/2:n2/2-1)/spatialExtentMinutes;

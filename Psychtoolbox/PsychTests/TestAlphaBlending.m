function TestAlphaBlending(screenNumber)

% TestAlphaBlending([screenNumber])
%
...
%
% TestAlphaBlending combines tests implemented separately.  You may perform
% any of these tests individually, or call TestAlphaBlending to perform
% them all:
%   
% TestAlphaBlendSetting - 
...
%   alpha values only.
%
% TestAlphaMultiplicationAccuracy - 

...
if isempty(gpubasedmorphing)
    ...
    if ~isempty(findstr(glGetString(GL.EXTENSIONS), 'GL_ARB_vertex_buffer_object')) && ...
            ~isempty(findstr(glGetString(GL.EXTENSIONS), 'GL_ARB_pixel_buffer_object')) && ...
            ~isempty(findstr(glGetString(GL.EXTENSIONS), 'GL_EXT_framebuffer_object')) && ...
            ...
            (~isempty(findstr(glGetString(GL.EXTENSIONS), 'GL_APPLE_float_pixels')) || ...
             ~isempty(findstr(glGetString(GL.EXTENSIONS), 'GL_ARB_color_buffer_float')))

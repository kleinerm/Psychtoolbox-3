function [ r, objX, objY, objZ, objW ] = gluUnProject4( winX, winY, winZ, clipW, model, proj, view, near, far )

% gluUnProject4  Interface to OpenGL function gluUnProject4
%
% usage:  [ r, objX, objY, objZ, objW ] = gluUnProject4( winX, winY, winZ, clipW, model, proj, view, near, far )
%

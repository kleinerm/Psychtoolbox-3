...
%
% 'clutOrTexturePtr' will either be a 256x3 matrix in the range specified
% by Screen('ColorRange') or it will be a texture generated by
% BitsPlusPlusClut2Texture.
%

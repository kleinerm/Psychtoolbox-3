function err=DaqSetSync(device,type)
% err=DaqSetSync(device,type)
% USB-1208FS: Configure sync input/output. 
% "device" is a small integer, the array index specifying which HID device
%         in the array returned by PsychHID('Devices') is interface 0 
...
err=PsychHID('SetReport',device,2,67,uint8([67 type])); % SetSync
if err.n

...
% initial distribution release, not even bug fixes. E.g., latest RPi OS in early
...
%      display server ("wayfire" or "labwc") is used by default, instead of a XOrg X-Server.

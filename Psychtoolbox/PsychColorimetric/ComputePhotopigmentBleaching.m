...
% 2.46e+06 (6.39 log10 isomerizations/cone-sec).  [Computations done 5/23/14 using
% IsomerizationsInEyeDemo and setting the fundamentals to 'CIE10deg' and wavelength to 560 nm
% by hand in the code.]
%

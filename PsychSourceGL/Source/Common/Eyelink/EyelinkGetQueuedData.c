...
"CAUTION: Raw fields are not yet supported on 64-Bit Linux. It may or may not work on your setup with your tracker.\n\n"
...
#else
		PsychErrorExitMsg(PsychError_unimplemented, "EyeLink: GetQueuedData:  Sorry, collecting raw values is not yet supported on 64-Bit Linux (do not supply an eye argument).");
#endif
	} else {

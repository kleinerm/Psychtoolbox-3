...
static void InitErrorStrings(void)
{
	...
	errorStringsERROR[PsychError_invalidIntegerArg]= 			"Supplied value was either fractional or outside of allowed range: -32767 >= x <=+32767";
	errorStringsERROR[PsychError_invalidWindex]= 				"Invalid Window Index";

...
static char synopsisString[] = 
        ...
        "On Linux, the optional 'deviceIndex' is the index of the keyboard device whose queue should be started. "
        "If omitted, the default keyboard's queue will be started. On other systems, the last queue will be started.\n";

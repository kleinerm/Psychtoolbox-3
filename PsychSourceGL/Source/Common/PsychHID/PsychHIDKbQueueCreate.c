...
static char useString[]= "PsychHID('KbQueueCreate', [deviceNumber][, keyFlags=all][, numValuators=0][, numSlots=10000])";
//                                                   1               2               3                 4
...
PsychError PSYCHHIDKbQueueCreate(void)
{
    ...
    PsychErrorExit(PsychCapNumInputArgs(4)); // Optionally specifies the deviceNumber of the keyboard or keypad to scan and an array of keyCode indicators.
    ...
    rc = PsychHIDOSKbQueueCreate(deviceIndex, numScankeys, scanKeys, numValuators, numSlots);

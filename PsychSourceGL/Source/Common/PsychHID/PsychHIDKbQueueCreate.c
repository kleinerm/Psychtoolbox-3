...
PsychError PSYCHHIDKbQueueCreate(void) 
{
    ...
    long KbDeviceUsagePages[NUMDEVICEUSAGES]= {kHIDPage_GenericDesktop, kHIDPage_GenericDesktop}, KbDeviceUsages[NUMDEVICEUSAGES]={kHIDUsage_GD_Keyboard, kHIDUsage_GD_Keypad}; // Keyboards and keypads
	...
	}
	{
		...
		}
		{
			...
			for (i=0; i<CFArrayGetCount(elements); i++)
			{
				...
				// Get usage page and make sure it is a keyboard or keypad

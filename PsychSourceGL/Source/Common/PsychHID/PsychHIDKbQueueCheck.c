...
static char synopsisString[] = 
		...
		"to be returned.\n"
        "On Linux, the optional 'deviceIndex' is the index of the keyboard device whose queue should be checked. "
        "If omitted, the default keyboard's queue will be checked. On other systems, the last queue will be checked.\n";        

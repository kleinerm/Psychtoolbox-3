...
PsychError PSYCHHIDKbQueueGetEvent(void)
{
    ...
    static char synopsisString[] =
        ...
        "For 'Type' 2/3/4 events, the location of the touch point, e.g., finger location on a touch-screen.\n"
        ...
        "under Linux/X11 return meaningful values: Absolute touch devices (touch screens, tablets etc.) are normalized "
        "to the range 0.0 - 1.0. Relative devices (touchpads) are normalized to a total range of 1.0.\n"
        ...
        "For 'Type' 2/3/4 events, additional device specific info about further touch properties, e.g., contact area "

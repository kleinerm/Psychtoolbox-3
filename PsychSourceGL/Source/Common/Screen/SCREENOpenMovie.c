...
static char synopsisString[] = 
		...
		"PsychPortAudio sound output, otherwise movie playback may hang. A setting of 4 or 8 will decode the video at "
        "a lower resolution (4 == half resolution, 8 == quarter resolution). This sacrifices video quality but "
		"can increase the decoding speed for speed critical movie playback. Low resolution playback may not be supported "
		"by all codecs.\n"

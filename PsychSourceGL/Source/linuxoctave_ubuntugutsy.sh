# Build GetSecs.oct ...
#./mex2oct_ubuntugutsy -r Octave/GetSecs.cc -IOctave -ICommon/Base -ILinux/Base -ICommon/GetSecs -ICommon/Screen Common/Base/*.cc Linux/Base/*.c Common/Base/*.c Common/GetSecs/*.c -g -lc -v

...
GetSecs = Extension('GetSecs',
                    ...
                    sources = ['Common/Base/MiniBox.c', 'Common/Base/PsychInstrument.c', 'Common/Base/ProjectTable.c', 'Common/Base/PsychError.c',
                               'Common/Base/PsychHelp.c', 'Common/Base/PsychRegisterProject.c',  'Common/Base/PsychVersioning.c', 'Common/Base/PsychAuthors.c',
                               'Common/Base/PsychInit.c', 'Common/Base/MODULEVersion.c', 'Common/Base/PsychScriptingGlue.c', 'Linux/Base/PsychTimeGlue.c',

...
if mode==1
    ...
    unix(['mv ../Projects/Linux/build/GetSecs.mex ' PsychtoolboxRoot 'PsychBasic/Octave3LinuxFiles/']);
...
if mode==2
    ...
    unix(['mv ../Projects/Linux/build/WaitSecs.mex ' PsychtoolboxRoot 'PsychBasic/Octave3LinuxFiles/']);
...
if mode==3
    ...
    unix(['mv ../Projects/Linux/build/PsychPortAudio.mex ' PsychtoolboxRoot 'PsychBasic/Octave3LinuxFiles/']);
...
if mode==4
    ...
    unix(['mv ../Projects/Linux/build/Eyelink.mex ' PsychtoolboxRoot 'PsychBasic/Octave3LinuxFiles/']);
...
if mode==5
    ...
    unix(['mv ../Projects/Linux/build/IOPort.mex ' PsychtoolboxRoot 'PsychBasic/Octave3LinuxFiles/']);
...
if mode==6
    ...
    unix(['mv moglcore.mex ' PsychtoolboxRoot 'PsychBasic/Octave3LinuxFiles/']);
    cd(curdir);
...
if mode==7
    ...
    unix(['mv ../Projects/Linux/build/PsychKinectCore.mex ' PsychtoolboxRoot 'PsychBasic/Octave3LinuxFiles/']);
    striplibsfrommexfile([PsychtoolboxRoot 'PsychBasic/Octave3LinuxFiles/PsychKinectCore.mex']);
end;

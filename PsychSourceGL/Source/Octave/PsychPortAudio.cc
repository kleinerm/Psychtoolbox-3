...
// module PsychPortAudio. It defines the entry-point function FPsychPortAudio and the online
// help for PsychPortAudio. The function itself (see bottom of file) is just a
...
#ifdef PTBOCTAVE
#define PTBMODULE_PsychPortAudio
...
extern "C" {
  ...
  const char *mexFunctionName = "PsychPortAudio";
} ;

DEFUN_DLD(PsychPortAudio, args, nargout,
"PsychPortAudio not directly documented. Try the following:\n   type(file_in_loadpath('PsychPortAudio.m'))\n")

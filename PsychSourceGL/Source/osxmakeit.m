...
if mode==0
    ...
    % Build with Weak linking of GStreamer via -weak_library flag. This
    % means that a missing GStreamer installation will not cause linker
    % failure at Screen() load time -- Screen continues to work as long as
    % no GStreamer-dependent functions are used. In that case it will abort
    ...
    mex -v -outdir ../Projects/MacOSX/build -output Screen -largeArrayDims -DPTBMODULE_Screen -DPTB_USE_GSTREAMER ...
        ...
        -lxml2 -lgthread-2.0 -lglib-2.0 % -ldc1394 -lusb-1.0

...
if mode==0
    ...
    % Build Screen:
    % Weak linking of GStreamer (partial example libgstreamer-0.10.0.dylib): mex -v -outdir ../Projects/MacOSX/build -output Screen -largeArrayDims -DPTBMODULE_Screen -DPTB_USE_GSTREAMER LDFLAGS="\$LDFLAGS -weak_library /System/Library/Frameworks/GStreamer.framework/Versions/Current/lib/libgstreamer-0.10.0.dylib -framework CoreServices -framework CoreFoundation -framework ApplicationServices -framework CoreAudio -framework OpenGL -framework CoreVideo -framework IOKit -framework AGL -framework SystemConfiguration -framework Carbon" CFLAGS="" CXXFLAGS="" -I/usr/include -I/System/Library/Frameworks/GStreamer.framework/Versions/Current/include/gstreamer-0.10 -I/System/Library/Frameworks/GStreamer.framework/Versions/Current/include/libxml2 -I/System/Library/Frameworks/GStreamer.framework/Versions/Current/include/glib-2.0 -I/System/Library/Frameworks/GStreamer.framework/Versions/Current/lib/glib-2.0/include -ICommon/Base -ICommon/Screen -IOSX/Base -IOSX/Screen -IOSX/Fonts -IOSX/EthernetAddress "Common/Base/*.cc" "Common/Screen/*.c" "OSX/Base/*.c" "OSX/Screen/*.c" "OSX/Fonts/*FontGlue*.c" "OSX/Fonts/FontInfo.c" "OSX/EthernetAddress/*.c" "Common/Base/*.c" -L/System/Library/Frameworks/GStreamer.framework/Versions/Current/lib -lgstreamer-0.10 -lgstbase-0.10 -lgstapp-0.10 -lgstinterfaces-0.10 -lgobject-2.0 -lgmodule-2.0 -lxml2 -lgthread-2.0 -lglib-2.0 % -ldc1394 -lusb-1.0
    mex -v -outdir ../Projects/MacOSX/build -output Screen -largeArrayDims -DPTBMODULE_Screen -DPTB_USE_GSTREAMER LDFLAGS="\$LDFLAGS -framework CoreServices -framework CoreFoundation -framework ApplicationServices -framework CoreAudio -framework OpenGL -framework CoreVideo -framework IOKit -framework AGL -framework SystemConfiguration -framework Carbon" CFLAGS="" CXXFLAGS="" -I/usr/include -I/System/Library/Frameworks/GStreamer.framework/Versions/Current/include/gstreamer-0.10 -I/System/Library/Frameworks/GStreamer.framework/Versions/Current/include/libxml2 -I/System/Library/Frameworks/GStreamer.framework/Versions/Current/include/glib-2.0 -I/System/Library/Frameworks/GStreamer.framework/Versions/Current/lib/glib-2.0/include -ICommon/Base -ICommon/Screen -IOSX/Base -IOSX/Screen -IOSX/Fonts -IOSX/EthernetAddress "Common/Base/*.cc" "Common/Screen/*.c" "OSX/Base/*.c" "OSX/Screen/*.c" "OSX/Fonts/*FontGlue*.c" "OSX/Fonts/FontInfo.c" "OSX/EthernetAddress/*.c" "Common/Base/*.c" -L/System/Library/Frameworks/GStreamer.framework/Versions/Current/lib -lgstreamer-0.10 -lgstbase-0.10 -lgstapp-0.10 -lgstinterfaces-0.10 -lgobject-2.0 -lgmodule-2.0 -lxml2 -lgthread-2.0 -lglib-2.0 % -ldc1394 -lusb-1.0

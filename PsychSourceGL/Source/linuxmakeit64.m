...
if mode==6
    ...
    try
    mex CFLAGS='$CFLAGS -fPIC -std=gnu99 -fexceptions -pthread' -v -outdir ./ -output moglcore -DLINUX -DGLEW_STATIC -largeArrayDims -DMEX_DOUBLE_HANDLE -I./ -I/usr/X11R6/include -L/usr/X11R6/lib -lc -lGL -lGLU -lglut moglcore.c gl_auto.c gl_manual.c glew.c mogl_rebinder.c ftglesGlue.c
    catch %#ok<*CTCH>
    end
...
if mode==9
    ...
    try
       mex CFLAGS='$CFLAGS -fPIC -std=gnu99 -fexceptions -pthread' -v -outdir ./ -output moalcore -largeArrayDims -DMEX_DOUBLE_HANDLE -DLINUX -lc -lopenal moalcore.c al_auto.c al_manual.c alm.c
    catch
    end
...
if mode == 11
    ...
    try
        mex -O -g -v CFLAGS='$CFLAGS -fPIC -std=gnu99 -fexceptions -pthread' -largeArrayDims -DMEX_DOUBLE_HANDLE pnet.c
    catch
    end

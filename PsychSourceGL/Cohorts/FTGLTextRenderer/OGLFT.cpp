...
// MK changed:
#else
// Noop function to make linker happy:
QString Face::format_number ( const QString& format, double number ) { return( QString() ); }
#endif /* #if OGLFT_QT_VERSION != 0 */

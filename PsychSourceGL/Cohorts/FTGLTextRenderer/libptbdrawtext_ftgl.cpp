 ...
 * Building for Linux:
 * 
 * g++ -g -I. -I/usr/include/ -I/usr/include/freetype2/ -L/usr/lib -l GL /usr/lib/libGLU.a -l fontconfig -l freetype -pie -shared -o libptbdrawtext_ftgl.so libptbdrawtext_ftgl.cpp qstringqcharemulation.cpp OGLFT.cpp
 *

Notice: As a modification by MK this folder also contains
lib/libfreeglut.a, which is the import library needed for
MinGW32 builds with the gcc compiler for our 32-Bit Octave-4
support on Windows. The libfreeglut.lib would be the 32-Bit
import library for MSVC, ie., for 32-Bit Matlab, which we
no longer do.
